...
//CODE HERE
greetUser = (name) => console.log("Welcome back, " + name);
greetUser("Andrew")
...
function canWeDeliver(zipcode)
{
    ...
    {console.log("You're in our delivery zone! Delivery ZipCode:" + zipcode)}
    else {console.log("Sorry, we can't deliver to that address. Delivery ZipCode:" + zipcode)}
}
canWeDeliver(85213)
canWeDeliver(48188)
console.log("----------------------")
...
function canWeDeliverTwo(zipcode)
{
   ...
   if(foundZipCode===1)
    ...
    console.log("Sorry, we can't deliver to that address. Delivery ZipCode:" + zipcode)
}
canWeDeliverTwo(85213)
canWeDeliverTwo(48188)
console.log("----------------------")
...
let dealTitle = "15% of all products"
dealTitle=dealTitle.replace("15","10")
...
//CODE HERE
let secondDeal=" 15% of all products for the month of March "
console.log(secondDeal)
secondDeal=secondDeal.replace("March","April").trim()
console.log(secondDeal)